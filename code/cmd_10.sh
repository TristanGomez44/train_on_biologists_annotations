...
python3 processResults.py -c model_cub10.config --exp_id CUB10 --plot_points_image_dataset_grid --image_nb 100 \
						...
						--rise 		     False False False True  False False	False False False False False False False \
						--gradcam 	     True  True  False False True 	True	True  True  False False False False False \
						--gradcam_maps   False False False False False True		False False False False False False False \
						--gradcam_pp     False True  False False False False	False False False False False False False \
						--score_map      False False False False True	False	False False False False False False False \
						--vargrad        False False False False False	False	True  False False False False False False \
						--smoothgrad_sq  False False False False False	False	False True  False False False False False \
						--interp 	     True  True  True  True  True 	False	True  True  True  True  True  True  False \
...
python3 processResults.py -c model_cars10.config --exp_id CARS10 --plot_points_image_dataset_grid --image_nb 200 \
						--model_ids noneRed noneRed noneRed noneRed noneRed noneRed noneRed noneRed bilRed interbyparts modelprototree clus_mast \
						--plot_id comp_rise_cars  \
						--ind_to_keep 135 39 84 --nrows 1 \
...
python3 processResults.py -c model_cub10.config --exp_id CUB10 --plot_points_image_dataset_grid --image_nb 100 \
						--model_ids  protopnet \
						--plot_id test_protopnet --nrows 5 \
						--only_norm      False  \
						--rise 		     False  \
						--gradcam 	     False  \
						--gradcam_maps   False  \
