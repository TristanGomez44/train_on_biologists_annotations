case $1 in
  ...
  "bilRed2_r50_all_moreannot_reg")
    ...
    ;;
  "bilRed2_r50_all_moreannot_reg_zmos")
    python trainVal.py -c grade_dl4ivf.config --model_id bilRed2_r50_all_moreannot_reg_zmos --first_mod resnet50 --big_images True --batch_size 32 --val_batch_size 215 --start_mode scratch --task_to_train all --resnet_bilinear True --bil_cluster False --regression True --zmos True $2
    ;;
