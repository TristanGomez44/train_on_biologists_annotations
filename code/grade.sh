case $1 in
 ...
 "noneRed2_lr_swin_regression")
  ...
  "noneRed2_ssl_noaug_only_center")
    ...
    ;;
  "noneRed2_ssl_noaug_only_center_sgd_nosched")
    python trainVal.py -c ssl.config --model_id noneRed2_ssl_noaug_only_center_sgd_nosched --epochs 1000 --first_mod resnet50  --big_images True --batch_size 16 --val_batch_size 32 --ssl True --dataset_path /LAB-DATA/LS2N/E144069X/DL4IVF/ --num_workers 2 --ssl_data_augment False --only_center_plane True --optim SGD --use_scheduler False
    ;;
