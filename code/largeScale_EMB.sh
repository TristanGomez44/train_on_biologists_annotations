case $1 in
  "bil")
    ...
    ;;
  "clusCat")
    python trainVal.py -c model_emb.config --exp_id EMB --model_id bilClusCat --epochs 300  --aux_model False --aux_mod_nll_weight 0 --first_mod $2   --resnet_bilinear True --bil_cluster True --bil_cluster_ensemble False --val_batch_size 25
    ;;
  "clusCatSoftm")
    python trainVal.py -c model_emb.config --exp_id EMB --model_id bilClusCat_softm --epochs 300  --aux_model False --aux_mod_nll_weight 0 --first_mod $2   --resnet_bilinear True --bil_cluster True --bil_cluster_ensemble False --val_batch_size 25 --apply_softmax_on_sim True --softm_coeff 1
    ;;
  "clusNoGate")
