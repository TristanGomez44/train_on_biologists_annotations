case $1 in
  ...
  "clus-BD-nod-nob-sc-hr-16prts")
    ...
    ;;
  "clus-BD-nod-nob-sc-hr-32prts")
    python trainVal.py -c model_cub4.config --exp_id CUB5 --model_id clus-BD-nd-nb-sc-hr-32prts       --epochs 300  --aux_model False  --aux_mod_nll_weight 0 --first_mod $2    --resnet_bilinear True  --resnet_simple_att_score_pred_act_func relu --resnet_layer_size_reduce True --batch_size 12 --dropout 0 --lin_lay_bias False --use_scheduler True --big_images True --stride_lay2 2 --stride_lay3 1 --stride_lay4 1 --bil_cluster True --resnet_bil_nb_parts 32
    ;;
  "clus-BD-nod-nob-sc-hr-64prts")
    python trainVal.py -c model_cub4.config --exp_id CUB5 --model_id clus-BD-nd-nb-sc-hr-64prts       --epochs 300  --aux_model False  --aux_mod_nll_weight 0 --first_mod $2    --resnet_bilinear True  --resnet_simple_att_score_pred_act_func relu --resnet_layer_size_reduce True --batch_size 12 --dropout 0 --lin_lay_bias False --use_scheduler True --big_images True --stride_lay2 2 --stride_lay3 1 --stride_lay4 1 --bil_cluster True --resnet_bil_nb_parts 64
    ;;
  ...
  "clusCat")
    ...
    ;;
  "clusCat-birdDataset")
    python trainVal.py -c model_cub4.config --exp_id CUB5 --model_id bilClusCat-birdDataset --epochs 300  --aux_model False --aux_mod_nll_weight 0 --first_mod $2   --resnet_bilinear True --bil_cluster True --bil_cluster_ensemble False --use_bird_dataset True --with_seg False
    ;;
  "clusCat-fix")
  ...
  "clusCat-01")
    ...
    ;;
  "clusCat-12")
    python trainVal.py -c model_cub4.config --exp_id CUB5 --model_id bilClusCat_vec12 --epochs 300  --aux_model False --aux_mod_nll_weight 0 --first_mod $2   --resnet_bilinear True --bil_cluster True --bil_cluster_ensemble False --bil_clus_vect_ind_to_use 1,2
    ;;
  "clusCatVecGate")
