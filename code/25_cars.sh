...
./largeScale_25.sh noneRed2 model_cars25.config
./largeScale_25.sh noneRed_focal2 model_cars25.config

./eval_expl_25.sh model_cars25.config all all noneRed2 all default
./eval_expl_25.sh model_cars25.config all all noneRed_focal2 all default
