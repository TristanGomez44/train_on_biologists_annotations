...
./eval_expl_25.sh model_cars25.config all all noneRed2_lr all default 1800 False 
./eval_expl_25.sh model_cars25.config all all noneRed_focal2_lr all default 1800 False
