case $1 in
 ...
 "1_none_mast")
  ...
  "noneRed_attMetrMask_FT_schedsimclr")
    ...
    ;; 
  "noneRed_attMetrMask_FT_linschedsimclr")
    python trainVal.py -c model_crohn2.config --model_id noneRed_attMetrMask_FT_linschedsimclr --resnet_bilinear False  --big_images True  --stride_lay3 2 --stride_lay4 2 --sal_metr_mask True --epochs 500 --nce_weight_sched True --start_mode fine_tune --init_path ../models/CROHN2/modelnoneRed_best_epoch46
    ;; 
  ...
  "noneRed_attMetrMask_FT_simclr_nonorm_proj")
    ...
    ;;
  "noneRed_attMetrMask_FT_simclr_proj")
    python trainVal.py -c model_crohn2.config --model_id noneRed_attMetrMask_FT_simclr_proj --resnet_bilinear False  --big_images True  --stride_lay3 2 --stride_lay4 2 --sal_metr_mask True --epochs 500 --start_mode fine_tune --init_path ../models/CROHN2/modelnoneRed_best_epoch46 --nce_weight 1 --val_batch_size 200 --nce_proj_layer True --nce_norm True
    ;;
  ...
  "noneRed_focalloss")
    ...
    ;;
  "noneRed_focalloss2")
    python trainVal.py -c model_crohn2.config --model_id noneRed_focalloss2 --resnet_bilinear False  --big_images True  --stride_lay3 2 --stride_lay4 2 --epochs 200 --nll_weight 0 --focal_weight 1 --sched_step_size 100 --sched_gamma 0.1 --weight_decay 1e-6 --val_batch_size 200
    ;;
  ...
  "noneRed_attMetrMask_FT_simclr_focal2")
    ...
    ;;
  "noneRed_attMetrMask_FT_simclr_focal2_balanced")
    python trainVal.py -c model_crohn2.config --model_id noneRed_attMetrMask_FT_simclr_focal2_balanced --resnet_bilinear False  --big_images True  --stride_lay3 2 --stride_lay4 2 --sal_metr_mask True --epochs 500  --nll_weight 0 --nce_weight 0.125 --focal_weight 0.5 --start_mode fine_tune --init_path ../models/CROHN2/modelnoneRed_focalloss_best_epoch171 --lr 0.0001 --use_scheduler False --weight_decay 1e-6
    ;;
