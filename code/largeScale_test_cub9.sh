case $1 in
  ...
  "clusEarlyExp")
    ...
    ;;
  "clusEarlyRed")
    python trainVal.py -c model_cub9.config --model_id clusEarl   --bil_cluster_early True --stride_lay3 2 --stride_lay4 2
    ;;
  "clusEarlyExpRed")
    python trainVal.py -c model_cub9.config --model_id clusEarlExp   --bil_cluster_early True --bil_clu_earl_exp True --stride_lay3 2 --stride_lay4 2
    ;;
  "clusAt1_GlobVec")
