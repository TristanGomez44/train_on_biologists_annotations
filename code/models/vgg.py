...
from torchvision.models import vgg16_bn as vgg16_bn_backbone,vgg19_bn as vgg19_bn_backbone
from torch import nn,flatten

constr_dict = {"vgg16_bn":vgg16_bn_backbone,"vgg19_bn":vgg19_bn_backbone}
...
class VGG(nn.Module):
    ...
    def __init__(self,backbone) -> None:
        ...
        self.backbone = constr_dict[backbone](weights='IMAGENET1K_V1')
    ...
    def forward(self,x):
        ...
        for layer in self.backbone.classifier[:-1]:
            x = layer(x)
        return {"feat":feat,"feat_pooled":x}
