...
./eval_expl_25.sh model_cub25.config all all noneRed2_lr all default 2048 False
./eval_expl_25.sh model_cub25.config all all noneRed_focal2_lr all default 2048 False
