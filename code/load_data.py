...
def buildTrainLoader(args,shuffle=True,random_transf=True):
    ...
    if args.ssl:
        ...
        train_dataset = grade_dataset.GradeDataset(args.dataset_name,args.dataset_path,"train",imgSize,random_transf=random_transf,distr_learn=args.distribution_learning,zmos=args.zmos)
...
def buildTestLoader(args, mode,random_transf=False):
    ...
    if args.ssl:
        ...
        test_dataset = grade_dataset.GradeDataset(args.dataset_name,args.dataset_path,mode,imgSize,random_transf=random_transf,distr_learn=args.distribution_learning,zmos=args.zmos)
