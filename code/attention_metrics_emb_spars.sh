case $1 in
    "all")
        ...
        python trainVal.py -c model_emb10.config --optuna False --attention_metrics Spars --model_id noneRed                               --att_metrics_post_hoc "xgradcam"  --stride_lay3 2 --stride_lay4 2 --att_metrics_few_steps True  --att_metr_do_again False  
        python trainVal.py -c model_emb10.config --optuna False --attention_metrics Spars --model_id noneRed                               --att_metrics_post_hoc "ablation_cam"  --stride_lay3 2 --stride_lay4 2 --att_metrics_few_steps True  --att_metr_do_again False  
    ;;
    "*")
        echo "no such model"
    ;;
